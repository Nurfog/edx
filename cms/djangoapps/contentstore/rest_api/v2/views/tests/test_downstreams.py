...
class PostDownstreamSyncViewTest(_DownstreamViewTestMixin, SharedModuleStoreTestCase):
    """
...
class DeleteDownstreamSyncViewtest(_DownstreamViewTestMixin, SharedModuleStoreTestCase):
    """
